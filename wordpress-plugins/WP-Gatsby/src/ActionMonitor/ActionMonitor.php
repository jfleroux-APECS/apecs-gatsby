...
class ActionMonitor {
    ...
    public function trigger_dispatch() {
        ...
        if ( $should_call_build_webhooks ) {
            ...
            // curl   -X POST   -H "Accept: application/vnd.github.v3+json" -H "Authorization: token my_token"
            // https://api.github.com/repos/edieval/apecs-gatsby/actions/workflows/13975243/dispatches   -d '{"ref":"master"}'
            $webhook = $unique_webhooks[0];
            ...
            $args = apply_filters( 'gatsby_trigger_dispatch_args', [
